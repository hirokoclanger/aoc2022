#pragma once
	...
	template<typename T>
	void HashCombine(unsigned long long& seed, const T& value)
	{
	...
	void HashCombine(unsigned long long& seed, const T& value, const Args&... args)
	{
	...
	void HashRange(unsigned long long& seed, It first, It last)
	{
...
#define IMPLEMENT_STD_HASH(T, ...) \
	...
	{\
		...
		{\
			...
			{\
				auto result = 0ull;\
				HashCombine(result, __VA_ARGS__);\
				return result;\
			}\
		};\
	}
